...
/* harmony import */ var _pages_dealdetail_dealdetail_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pages/dealdetail/dealdetail.page */ "./src/app/pages/dealdetail/dealdetail.page.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _pages_errors_errors_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pages/errors/errors.page */ "./src/app/pages/errors/errors.page.ts");
...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | pages-visit-revisit-revisit-module */[__webpack_require__.e("default~pages-visit-paymentcancel-paymentcancel-module~pages-visit-paymentcomplete-certificationuplo~d850730b"), __webpack_require__.e("common"), __webpack_require__.e("pages-visit-revisit-revisit-module")]).then(__webpack_require__.bind(null, /*! ./pages/visit/revisit/revisit.module */ "./src/app/pages/visit/revisit/revisit.module.ts")).then((m) => m.RevisitPageModule),
    },
    {
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | pages-visit-paymentcomplete-certificationupload-certificationupload-module */[__webpack_require__.e("default~pages-visit-paymentcancel-paymentcancel-module~pages-visit-paymentcomplete-certificationuplo~d850730b"), __webpack_require__.e("pages-visit-paymentcomplete-certificationupload-certificationupload-module")]).then(__webpack_require__.bind(null, /*! ./pages/visit/paymentcomplete/certificationupload/certificationupload.module */ "./src/app/pages/visit/paymentcomplete/certificationupload/certificationupload.module.ts")).then((m) => m.CertificationuploadPageModule),
    },
    {
        path: 'home/visit/result/paymentcancel/:id',
        loadChildren: () => Promise.all(/*! import() | pages-visit-paymentcancel-paymentcancel-module */[__webpack_require__.e("default~pages-visit-paymentcancel-paymentcancel-module~pages-visit-paymentcomplete-certificationuplo~d850730b"), __webpack_require__.e("common"), __webpack_require__.e("pages-visit-paymentcancel-paymentcancel-module")]).then(__webpack_require__.bind(null, /*! ./pages/visit/paymentcancel/paymentcancel.module */ "./src/app/pages/visit/paymentcancel/paymentcancel.module.ts")).then((m) => m.PaymentcancelPageModule),
    },
    {
        path: 'home/visit/:id',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-visit-visit-module */ "pages-visit-visit-module").then(__webpack_require__.bind(null, /*! ./pages/visit/visit.module */ "./src/app/pages/visit/visit.module.ts")).then((m) => m.VisitPageModule),
    },
    {
        path: 'home/visit/result/:id',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-visit-result-result-module */ "pages-visit-result-result-module").then(__webpack_require__.bind(null, /*! ./pages/visit/result/result.module */ "./src/app/pages/visit/result/result.module.ts")).then((m) => m.ResultPageModule),
    },
    {
        path: 'home/payment/:id',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-visit-payment-payment-module */ "pages-visit-payment-payment-module").then(__webpack_require__.bind(null, /*! ./pages/visit/payment/payment.module */ "./src/app/pages/visit/payment/payment.module.ts")).then((m) => m.PaymentPageModule),
    },
    {
        path: '',
        redirectTo: '',
    ...
    { path: '**', component: _pages_errors_errors_page__WEBPACK_IMPORTED_MODULE_4__["ErrorsPage"] },
];
...
/* harmony import */ var _services_routerext_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/routerext.service */ "./src/app/services/routerext.service.ts");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_7__["NgModule"])({
        ...
        imports: [
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_16__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].firebase),
        ...
        providers: [
            ...
            _services_routerext_service__WEBPACK_IMPORTED_MODULE_2__["RouterExtService"],
...
/* harmony import */ var src_app_services_deals_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/deals.service */ "./src/app/services/deals.service.ts");
...
let DealdetailPage = class DealdetailPage {
    constructor(dealsService, router, route, notiService, afAuth, loader, translate) {
    ...
    getDealDetail(id) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.dealSub = yield this.dealsService
                .getDealDetail(id)
                .subscribe((val) => {
    ...
    getDealerInParticipant(id) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.dealsService.getDealerInParticipant(id).subscribe((val) => {
                if (val) {
    ...
    addDealerToDeal() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield this.dealsService.updateDeal(this.id, { status: 2 });
...
MainPipe = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _toast_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./toast.service */ "./src/app/services/toast.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
...
let AuthService = class AuthService {
    constructor(afAuth, router, toast, fireStore) {
        this.afAuth = afAuth;
        this.router = router;
        this.toast = toast;
    ...
    signup(email, password) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield this.toast.showToast('Your account have been created, Please login!');
            // this.router.navigate(['login']);
        });
    }
    registerDealer(content) {
        return this.fireStore.collection('register_request').add(content);
    }
    updateRegisterDealer(id, content) {
        this.fireStore
...
let DealsService = class DealsService {
    ...
    getDeal() {
        return this.fireStore
            .collection('requests', (ref) => ref.where('expiredTime', '>=', this.now).orderBy('expiredTime', 'desc'))
            .snapshotChanges();
    }
    getDealerInParticipant(id) {
        return this.fireStore
    ...
    getOngoingDeal(id) {
        return this.fireStore
            .collection('Dealer')
            .doc(id)
            .collection('Deals', (ref) => ref.where('canceled', '==', false).orderBy('bidTime', 'desc'))
            .snapshotChanges();
    }
    getDealDetail(id) {
...
let RouterExtService = class RouterExtService {
    constructor(router) {
        this.router = router;
...
RouterExtService.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }
];
...
module.exports = __webpack_require__(/*! /Users/trannhan/Downloads/Source/Project/SCRoadsFinal/SCRoad_Dealer/src/main.ts */"./src/main.ts");
