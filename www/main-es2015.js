...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _services_routerext_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./services/routerext.service */ "./src/app/services/routerext.service.ts");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_6__["NgModule"])({
        ...
        imports: [
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_15__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].firebase),
        ...
        providers: [
            ...
            _services_routerext_service__WEBPACK_IMPORTED_MODULE_1__["RouterExtService"],
...
let DealdetailPage = class DealdetailPage {
    ...
    addDealerToDeal() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield this.dealsService.addDealToDealer(this.userId, {
                dealId: this.id,
                price: this.price,
                bidTime: this.bidTime,
            });
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _toast_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./toast.service */ "./src/app/services/toast.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
...
let AuthService = class AuthService {
    constructor(afAuth, router, toast) {
        this.afAuth = afAuth;
        this.router = router;
        this.toast = toast;
...
let DealsService = class DealsService {
    ...
    getDealerInParticipant(id, user) {
    ...
    getSelectedDealer(id, user) {
        return this.fireStore
            .collection('requests')
            .doc(id)
            .collection('participants', (ref) => ref.where('userId', '==', user).where('selected', '==', true))
            .valueChanges();
    }
    getOngoingDeal(id) {
        return this.fireStore
...
module.exports = __webpack_require__(/*! /Volumes/Data/Project/SCRoadsFinal/SCRoad_Dealer/src/main.ts */"./src/main.ts");
