...
/* harmony import */ var _deal_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./deal-routing.module */ "./src/app/pages/navigation/deal/deal-routing.module.ts");
/* harmony import */ var _deal_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./deal.page */ "./src/app/pages/navigation/deal/deal.page.ts");
...
DealPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _deal_routing_module__WEBPACK_IMPORTED_MODULE_5__["DealPageRoutingModule"]
        ],
...
let DealPage = class DealPage {
    constructor(modelService, dealService, locationService) {
    ...
    ngOnInit() {
        ...
        this.dealSub = this.dealService.getDeal().subscribe((data) => {
...
DealPage.ctorParameters = () => [
    { type: _services_model_service__WEBPACK_IMPORTED_MODULE_3__["ModelService"] },
