  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["ongoing-ongoing-module"], {
    ...
    function srcAppPagesNavigationOngoingOngoingPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var OngoingPage = /*#__PURE__*/function () {
        function OngoingPage(dealService) {
        ...
        _createClass(OngoingPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.dealService.getOngoingDeal(this.id).subscribe(function (val) {
              _this.ongoing = val.map(function (e) {
                return Object.assign({}, e.payload.doc.data());
              });

              _this.ongoing.forEach(function (val) {
                _this.dealService.getDealDetail(val.dealId).subscribe(function (m) {
                  val.deal = Object.assign({}, m.payload.data());
                });
              });

              console.log(_this.ongoing);
            });
          }
        }]);
      ...
      OngoingPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
