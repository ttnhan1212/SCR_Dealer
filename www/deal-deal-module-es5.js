(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["deal-deal-module"], {
    ...
    function srcAppPagesNavigationDealDealPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_model_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var DealPage = /*#__PURE__*/function () {
        function DealPage(modelService, dealService, locationService) {
        ...
        _createClass(DealPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.dealSub = this.dealService.getDeal().subscribe(function (data) {
              _this.deals = data.map(function (e) {
                return Object.assign({
                  id: e.payload.doc.id
                }, e.payload.doc.data());
              });
      ...
      DealPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
        selector: 'app-deal',
