...
const routes = [
    Object.assign({ path: '', component: _navigation_page__WEBPACK_IMPORTED_MODULE_1__["NavigationPage"], children: [
            ...
            {
                path: 'deal/detail',
                loadChildren: () => Promise.all(/*! import() | dealdetail-dealdetail-module */[__webpack_require__.e("default~dealdetail-dealdetail-module~settings-setting-module"), __webpack_require__.e("common"), __webpack_require__.e("dealdetail-dealdetail-module")]).then(__webpack_require__.bind(null, /*! ./dealdetail/dealdetail.module */ "./src/app/pages/navigation/dealdetail/dealdetail.module.ts")).then((m) => m.DealdetailPageModule),
            },
            {
                path: 'notifications',
            ...
            {
                path: 'settings',
                loadChildren: () => Promise.all(/*! import() | settings-setting-module */[__webpack_require__.e("default~dealdetail-dealdetail-module~settings-setting-module"), __webpack_require__.e("common"), __webpack_require__.e("settings-setting-module")]).then(__webpack_require__.bind(null, /*! ./settings/setting.module */ "./src/app/pages/navigation/settings/setting.module.ts")).then((m) => m.SettingPageModule),
            },
            {
                path: 'ongoing',
