(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_routerext_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_6__["NgModule"])({
        ...
        entryComponents: [],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_7__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_9__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_13__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_14__["BrowserAnimationsModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_15__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].firebase), _angular_fire_auth__WEBPACK_IMPORTED_MODULE_16__["AngularFireAuthModule"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestoreModule"], _angular_fire_storage__WEBPACK_IMPORTED_MODULE_17__["AngularFireStorageModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"]],
        providers: [_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], _services_routerext_service__WEBPACK_IMPORTED_MODULE_1__["RouterExtService"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_11__["StatusBar"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_10__["SplashScreen"], {
    ...
    function srcAppServicesDealsServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var DealsService = /*#__PURE__*/function () {
        function DealsService(fireStore) {
        ...
        _createClass(DealsService, [{
          ...
          key: "getDealerInParticipant",
          value: function getDealerInParticipant(id, user) {
          ...
          value: function getSelectedDealer(id, user) {
            return this.fireStore.collection('requests').doc(id).collection('participants', function (ref) {
              return ref.where('userId', '==', user).where('selected', '==', true);
            }).valueChanges();
          }
        }, {
          key: "getOngoingDeal",
          value: function getOngoingDeal(id) {
            return this.fireStore.collection('Dealer').doc(id).collection('Deals').snapshotChanges();
          }
        }, {
          key: "getDealDetail",
          value: function getDealDetail(id) {
          ...
          key: "addDealToDealer",
          value: function addDealToDealer(id, deal) {
            return this.fireStore.collection('Dealer').doc(id).collection('Deals').add(deal);
          }
        }, {
          key: "updateDeal",
      ...
      DealsService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
        providedIn: 'root'
      })], DealsService);
      /***/
    },
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /Volumes/Data/Project/SCRoadsFinal/SCRoad_Dealer/src/main.ts */
      "./src/main.ts");
      /***/
    }
  }, [[0, "runtime", "vendor"]]]);
